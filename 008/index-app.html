...
<html lang="en">
  <head>
    ...
    <title>Ethanol Portfolio Template - Index For App</title>
    ...
    <div id="tf-home" class="app">
        <div class="overlay"> <!-- Overlay Color -->
            <div class="container"> <!-- container -->
                <div class="row">
                    <div class="col-md-6">
                        <div class="content-heading text-left"> <!-- Input Your Home Content Here -->
                            ...
                            <a href="#" class="scroll goto-btn text-uppercase">Buy Now</a> <!-- Link to your portfolio section -->
                        ...
                        <div class="ipad-wrapper">
                            ...
                            <div class="app-wrap">
                                <div id="owl-demo" class="owl-carousel owl-theme">
                                  <div class="item"><img src="img/app/01.jpg" alt="The Last of us"></div>
                                  <div class="item"><img src="img/app/02.jpg" alt="GTA V"></div>
                                  <div class="item"><img src="img/app/03.jpg" alt="Mirror Edge"></div>
                                </div>
                            </div>
