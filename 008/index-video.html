...
<html lang="en">
  <head>
    ...
    <title>Ethanol Portfolio Template - Index Video Header</title>
            ...
            <div class="container"> <!-- container -->
                <div class="content-heading text-center"> <!-- Input Your Home Content Here -->
                    ...
                    <div class="img-wrapper">
                        <div id="popup" class="video-block">
                            <a href="https://www.youtube.com/watch?v=L9szn1QQfas"><i class="fa fa-play"></i></a>
                        </div>
                        <img src="img/header2.png" class="img-responsive light-opacity" alt="Image">
                    </div>
